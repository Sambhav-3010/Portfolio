    ...
    <div className="py-16 w-full flex flex-col items-center justify-center" id="projects">
      <div className="container mx-auto px-4 md:px-8 lg:px-16 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          <Card className={`flex flex-col items-center text-center p-6 rounded-lg shadow-lg ${mode === 'dark' ? 'bg-gray-800 text-white' : 'bg-white text-gray-900'} transition-transform duration-300 hover:scale-105`}>
            <CardHeader>
              ...
              <a href="https://github.com/Sambhav-3010" target="_blank" rel="noreferrer">
                <CardTitle className={`text-xl font-bold mb-2 ${mode === 'dark' ? 'text-white' : 'text-gray-900'} hover:text-blue-500 transition-colors duration-300`}>GhumoFiro</CardTitle>
              </a>
            </CardHeader>
            <CardContent>
          ...
          <Card className={`flex flex-col items-center text-center p-6 rounded-lg shadow-lg ${mode === 'dark' ? 'bg-gray-800 text-white' : 'bg-white text-gray-900'} transition-transform duration-300 hover:scale-105`}>
            <CardHeader>
              ...
              <a href="https://github.com/Sambhav-3010" target="_blank" rel="noreferrer">
                <CardTitle className={`text-xl font-bold mb-2 ${mode === 'dark' ? 'text-white' : 'text-gray-900'} hover:text-blue-500 transition-colors duration-300`}>PropChain</CardTitle>
              </a>
            </CardHeader>
            <CardContent>
              <p className={`text-base ${mode === 'dark' ? 'text-gray-300' : 'text-gray-700'}`}>
          ...
          <Card className={`flex flex-col items-center text-center p-6 rounded-lg shadow-lg ${mode === 'dark' ? 'bg-gray-800 text-white' : 'bg-white text-gray-900'} transition-transform duration-300 hover:scale-105`}>
            <CardHeader>
              ...
              <a href="https://github.com/Sambhav-3010" target="_blank" rel="noreferrer">
                <CardTitle className={`text-xl font-bold mb-2 ${mode === 'dark' ? 'text-white' : 'text-gray-900'} hover:text-blue-500 transition-colors duration-300`}>Rythmo</CardTitle>
              </a>
            </CardHeader>
            <CardContent>
              <p className={`text-base ${mode === 'dark' ? 'text-gray-300' : 'text-gray-700'}`}>
