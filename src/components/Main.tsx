      ...
      >
        <div className="relative z-10 flex flex-col md:flex-row items-center md:items-start gap-8 w-full max-w-6xl mx-auto py-16">
          <div className="shrink-0">
            <img src="https://my-aws-assets.s3.us-west-2.amazonaws.com/portfolio-img/avatar_circle.jpeg" alt="Avatar" className="rounded-full w-72 h-72 object-cover shadow-lg border-4 border-white dark:border-gray-800" />
          </div>
