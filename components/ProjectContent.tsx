...
import { ExternalLink, Github, ArrowLeft, RocketIcon } from "lucide-react";
      ...
      <div className="max-w-5xl mx-auto space-y-8 md:space-y-16">
                ...
                >
                  <div className="flex items-start gap-3 md:gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p
                        className={`text-xs md:text-sm mt-2 opacity-70 ${
                          project.status === "issues"
                            ? "text-red-300"
                            : "text-amber-300"
                        }`}
        ...
        <div className="w-full space-y-12">
          <section className="space-y-3 md:space-y-4">
            ...
            <div className="space-y-3 text-muted-foreground text-base md:text-lg leading-relaxed md:leading-loose">
              {project.description}
            </div>
          </section>
