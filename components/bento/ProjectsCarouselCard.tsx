...
export function ProjectsCarouselCard() {
    ...
    return (
        <div className="h-full min-h-[400px] md:min-h-[580px] p-6 rounded-2xl bg-card/60 backdrop-blur-sm border border-border/50 hover:border-primary/40 transition-all duration-300 hover:shadow-xl hover:shadow-primary/10 flex flex-col">
