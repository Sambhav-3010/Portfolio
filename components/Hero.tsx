    ...
    <section className="min-h-screen flex flex-col md:gap-20 lg:gap-32 gap-8 items-center justify-center md:flex-row-reverse px-6 py-20">
      <div className="shrink-0 mb-8">
        <div className="relative group">
          <div className="absolute -inset-1 bg-linear-to-r from-emerald-500 to-emerald-600 rounded-full blur opacity-75 group-hover:opacity-100 transition duration-1000 group-hover:duration-200 animate-pulse"></div>
          <Image
            src="/sambhav.jpg"
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-wrap gap-4 pt-4">
            <Button 
              ...
              size="lg" 
              asChild
              className="bg-emerald-500 hover:bg-emerald-600 text-black font-semibold transition-all hover:scale-105"
            >
          ...
          <div className="flex gap-5 pt-8 border-t border-[#2a2a2a]">
            <a
            ...
            <a
              ...
              download="resume.pdf"
              className="text-gray-400 hover:text-emerald-400 transition-all hover:scale-110 group relative"
            >
              <FileText className="h-6 w-6" />
              <span className="sr-only">Resume</span>
              <span className="absolute -top-10 left-1/2 -translate-x-1/2 bg-[#1a1a1a] text-gray-300 text-xs px-3 py-2 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none border border-[#2a2a2a] shadow-lg">
                Download Resume
              </span>
            </a>
          </div>
