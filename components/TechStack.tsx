      ...
      <div className="grid gap-6 md:grid-cols-2">
          ...
          <CardHeader>
            <div className="flex items-center gap-3 mb-2">
              <div className="p-2 bg-primary/10 rounded-lg group-hover:scale-110 transition-transform">
                <BiCodeAlt className="w-6 h-6 text-primary" />
              </div>
        ...
        <Card className="bg-card border-border hover:border-primary/50 transition-all duration-300 hover:shadow-lg hover:shadow-primary/10 group">
          <CardHeader>
            <div className="flex items-center gap-3 mb-2">
              ...
              <CardTitle className="text-xl text-card-foreground">Frameworks & Libraries</CardTitle>
            </div>
            <CardDescription className="text-muted-foreground">
        ...
        <Card className="bg-card border-border hover:border-primary/50 transition-all duration-300 hover:shadow-lg hover:shadow-primary/10 group">
          <CardHeader>
            <div className="flex items-center gap-3 mb-2">
              ...
              <CardTitle className="text-xl text-card-foreground">Databases</CardTitle>
            </div>
            <CardDescription className="text-muted-foreground">
        ...
        <Card className="bg-card border-border hover:border-primary/50 transition-all duration-300 hover:shadow-lg hover:shadow-primary/10 group">
          <CardHeader>
            ...
            <CardDescription className="text-muted-foreground">
              Development tools and problem-solving platforms
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="flex flex-wrap gap-2">
